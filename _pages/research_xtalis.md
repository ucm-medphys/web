...
<p markdown="0"><img src="{{ site.url }}{{ site.baseurl }}/images/xtalis/xtalis_logo_white.png" alt="XTALIS" style="display:block;max-width:360px;height:auto;margin:0 0 24px;border-radius:0;"></p>
